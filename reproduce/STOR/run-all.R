# =============================================================================
# run-all.R — reproduce every STOR result and figure in one command
# =============================================================================
...
#
# The method itself lives in R/02-stor-core.R and depends on no package.
# =============================================================================
...
STEPS <- c(
  "10" = "R/10-simulate-data.R",
  "20" = "R/20-srii.R",
  "30" = "R/30-dmu.R",
  "40" = "R/40-lisa.R",
  "50" = "R/50-income-models.R",
  "90" = "R/90-tables.R"
)
FIGURES <- c("R/p01-srii-maps.R", "R/p02-dmu-tradeoff.R", "R/p03-dmu-stages.R",
             "R/p04-lisa-tradeoff.R", "R/p05-income-contribution.R")
TESTS   <- c("tests/test-01-method-properties.R",
             "tests/test-02-recover-simulation.R")
