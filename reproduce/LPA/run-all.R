# =============================================================================
# run-all.R — reproduce every LPA result and figure in one command
# =============================================================================
...
# change without repeating the whole pipeline. Step 30 is the slow one, at
# roughly eight minutes for the full set of locations.
# =============================================================================
...
STEPS <- c(
  ...
  "20" = "R/20-optimal-range.R",
  "30" = "R/30-local-sem.R",
  "40" = "R/40-reproduce-published.R",
  "50" = "R/50-radius-sensitivity.R",
  "90" = "R/90-tables.R"
)
FIGURES <- c("R/p01-ripleys-k.R", "R/p02-lambda-maps.R",
             "R/p03-lambda-distributions.R", "R/p04-refit-agreement.R")
