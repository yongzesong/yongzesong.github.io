# =============================================================================
# run-all.R — reproduce every geocomplexity result and figure in one command
# =============================================================================
...
STEPS <- c(
  ...
  "20" = "R/20-geocomplexity.R",
  "30" = "R/30-baseline-models.R",
  "40" = "R/40-explain-errors.R",
  "50" = "R/50-improve-models.R",
  "90" = "R/90-tables.R"
)
FIGURES <- c("R/p01-gc-maps.R", "R/p02-error-explanation.R",
             "R/p03-methods-and-improvement.R")
